...
int main(int argc, char** argv)
{
    ...
    if (HelpRequested(argsman)) {
        std::cout << "Usage:  connectcoin-bench [options]\n"
                     "\n"
                  << argsman.GetHelpMessage()
                  << "Description:\n"
                     "\n"
                     "  connectcoin-bench executes microbenchmarks. The quality of the benchmark results\n"
                     ...
                     "\n"
                     "  * connectcoin-bench uses nanobench [3] for which there is extensive\n"
                     ...
                     "\n"
                     "    NANOBENCH_ENDLESS=MuHash ./connectcoin-bench -filter=MuHash\n"
                     "\n"
                     ...
                     "\n"
                     "    NANOBENCH_SUPPRESS_WARNINGS=1 ./connectcoin-bench\n"
                     "\n"
                     "Notes:\n"
                     "\n"
                     "  1. pyperf\n"
