...
#ifndef CONNECTCOIN_TEST_FUZZ_UTIL_THREADINTERRUPT_H
#define CONNECTCOIN_TEST_FUZZ_UTIL_THREADINTERRUPT_H
...
#endif // CONNECTCOIN_TEST_FUZZ_UTIL_THREADINTERRUPT_H
