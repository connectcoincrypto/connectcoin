...
#ifndef CONNECTCOIN_TEST_FUZZ_UTIL_H
#define CONNECTCOIN_TEST_FUZZ_UTIL_H
...
{
    while (!CheckProofOfWork(header, nullptr, chainman.GetParams().GetConsensus())) {
        ++(header.nNonce);
    }
}

#endif // CONNECTCOIN_TEST_FUZZ_UTIL_H
