...
BOOST_AUTO_TEST_CASE(feefrac_operators)
{
    ...
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeDown(1), 465661287);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeDown(2), 931322575);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeDown(3), 1396983862);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeDown(1256796054), 585241268661451185);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeDown(INT32_MAX), MAX_MONEY);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeUp(0), 0);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeUp(1), 465661288);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeUp(2), 931322576);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeUp(3), 1396983863);
    BOOST_CHECK_EQUAL(max_fee.EvaluateFeeUp(1256796054), 585241268661451186);
