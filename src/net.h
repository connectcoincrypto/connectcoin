...
/** Maximum length of incoming protocol messages, sufficient to relay a maximum-size block. */
inline constexpr unsigned int MAX_PROTOCOL_MESSAGE_LENGTH{50'000'000};
