...
#ifndef CONNECTCOIN_NOUI_H
#define CONNECTCOIN_NOUI_H
...
/** Connect all connectcoind signal handlers */
void noui_connect();

/** Redirect all connectcoind signal handlers to LogInfo. Used to check or suppress output during test runs that produce expected errors */
void noui_test_redirect();

/** Reconnects the regular Non-GUI handlers after having used noui_test_redirect */
void noui_reconnect();

#endif // CONNECTCOIN_NOUI_H
