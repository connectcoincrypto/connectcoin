...
#ifndef CONNECTCOIN_QT_BITCOINGUI_H
#define CONNECTCOIN_QT_BITCOINGUI_H
...
/**
  ConnectCoin GUI main class. This class represents the main window of the ConnectCoin UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a ConnectCoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed ConnectCoin Transaction from file or clipboard */
...
#endif // CONNECTCOIN_QT_BITCOINGUI_H
