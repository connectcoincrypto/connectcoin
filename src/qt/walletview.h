...
#ifndef CONNECTCOIN_QT_WALLETVIEW_H
#define CONNECTCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a ConnectCoin wallet, and offers access to
...
#endif // CONNECTCOIN_QT_WALLETVIEW_H
