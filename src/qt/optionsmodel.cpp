...
//! Get pruning enabled value to show in GUI from the ConnectCoin -prune setting.
...
//! Get pruning size value to show in GUI from the ConnectCoin -prune setting. If
