...
QT_TRANSLATE_NOOP("bitcoin-core", "Change destination must be a type-1 P2PK (bech32m) destination"),
QT_TRANSLATE_NOOP("bitcoin-core", "Config setting for %s only applied on %s network when in [%s] section."),
QT_TRANSLATE_NOOP("bitcoin-core", "ConnectCoin supports only type-1 P2PK (bech32m) addresses"),
QT_TRANSLATE_NOOP("bitcoin-core", "ConnectCoin supports only type-1 P2PK (bech32m) change addresses"),
QT_TRANSLATE_NOOP("bitcoin-core", "ConnectCoin transactions require valid type-1 destinations or type-2 PAY_TO_CONNECT outputs"),
QT_TRANSLATE_NOOP("bitcoin-core", "ConnectCoin type-1 outputs support only SIGHASH_DEFAULT"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Dumpfile version is not supported. This version of connectcoin-wallet only supports version 1 dumpfiles. Got dumpfile with version %s"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Input is not a complete type-1 SIGHASH_DEFAULT spend"),
QT_TRANSLATE_NOOP("bitcoin-core", "Input not found or already spent"),
QT_TRANSLATE_NOOP("bitcoin-core", "Input requires a complete P2C proof witness"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Mainnet has not been launched: no genesis block is defined. Use -testnet4 for public testing or -regtest for local testing."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "No project-owned public source URL is configured for this development build."),
QT_TRANSLATE_NOOP("bitcoin-core", "Not enough file descriptors available. %d available, %d required."),
QT_TRANSLATE_NOOP("bitcoin-core", "Not enough file descriptors available. Try reducing -rpcmaxconnections or using the default value of %d"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Please contribute if you find %s useful."),
