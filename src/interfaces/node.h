...
#ifndef CONNECTCOIN_INTERFACES_NODE_H
#define CONNECTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a ConnectCoin node (connectcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or connectcoin.conf.
...
#endif // CONNECTCOIN_INTERFACES_NODE_H
