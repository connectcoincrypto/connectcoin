...
#ifndef CONNECTCOIN_INTERFACES_CHAIN_H
#define CONNECTCOIN_INTERFACES_CHAIN_H
...
//! internal workings of the ConnectCoin node, and not being very convenient to use.
...
#endif // CONNECTCOIN_INTERFACES_CHAIN_H
