...
#ifndef CONNECTCOIN_ADDRESSTYPE_H
#define CONNECTCOIN_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a ConnectCoin address
 */
...
#endif // CONNECTCOIN_ADDRESSTYPE_H
