...
#ifndef CONNECTCOIN_INIT_H
#define CONNECTCOIN_INIT_H
...
/** Initialize ConnectCoin Core: Basic context setup.
...
/**
 * Lock ConnectCoin Core critical directories.
...
/**
 * ConnectCoin Core main initialization.
