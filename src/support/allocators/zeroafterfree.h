...
#ifndef CONNECTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CONNECTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CONNECTCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
