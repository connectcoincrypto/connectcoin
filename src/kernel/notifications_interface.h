...
#ifndef CONNECTCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
#define CONNECTCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // CONNECTCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
