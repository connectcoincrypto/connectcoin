...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-fallbackfee=<amt>", strprintf("A fee rate (in %s/kvB) that will be used when fee estimation has insufficient data. With 0 or no configured fallback, use the current economic network minimum (subsidy weight cost plus 1000 connects/kvB), respecting higher mempool and wallet minimums. (default: %s)",
