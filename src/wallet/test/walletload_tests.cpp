...
BOOST_FIXTURE_TEST_CASE(wallet_load_descriptors, TestingSetup)
{
    ...
    std::unique_ptr<WalletDatabase> database = CreateMockableWalletDatabase();
    {
        ...
        std::string unknown_desc = "trx(tcubNC1uBHhBxmWggsis5S71w9YjPHs1QJD2eW5odDDewEPDnSLxK7HN6cQrLEtVTim5vgzrkhbTBc6BS6ozQY6WjBf6MrJgdBQEz2nhdNUuJ5R/86'/1'/0'/0/*)#xe535ew5";
...

    {
        ...
        WalletBatch batch(*database);
        std::string desc = "wpkh([d34db33f/84h/0h/0h]ccpubKLseupAvr3wT83sz2g4wDtDkqAxjaJbH2E5qVQoMBQWwQSen3utNFQQB43wFU8VwSNuVLzrAKkekBN3sZ1D1JK1tssSQUY7YMW4sDDpDP1o/0/*)#wxjee0pc";
