...
#ifndef CONNECTCOIN_WALLET_WALLETUTIL_H
#define CONNECTCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! older Bitcoin Core-derived software from opening the wallet, thinking
    //! it was newly created, and
...
#endif // CONNECTCOIN_WALLET_WALLETUTIL_H
