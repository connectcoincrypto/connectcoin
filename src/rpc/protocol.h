...
#ifndef CONNECTCOIN_RPC_PROTOCOL_H
#define CONNECTCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in connectcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< ConnectCoin is not connected
...
#endif // CONNECTCOIN_RPC_PROTOCOL_H
