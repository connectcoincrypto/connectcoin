...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendtop2c", 1, "amount" },
    { "sendtop2c", 2, "work" },
    { "sendtop2c", 3, "root_certificates_version" },
    { "sendtop2c", 4, "comment", ParamFormat::STRING },
    { "sendtop2c", 5, "comment_to", ParamFormat::STRING },
    { "sendtop2c", 6, "subtractfeefromamount" },
    { "sendtop2c", 7, "replaceable" },
    { "sendtop2c", 8, "conf_target" },
    { "sendtop2c", 9, "estimate_mode", ParamFormat::STRING },
    { "sendtop2c", 10, "avoid_reuse" },
    { "sendtop2c", 11, "fee_rate" },
    { "sendtop2c", 12, "verbose" },
