...
//! that can be used internally by functions in the libconnectcoin_common library,
...
#ifndef CONNECTCOIN_COMMON_TYPES_H
#define CONNECTCOIN_COMMON_TYPES_H
...
#endif // CONNECTCOIN_COMMON_TYPES_H
