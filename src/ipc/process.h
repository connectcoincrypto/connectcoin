...
#ifndef CONNECTCOIN_IPC_PROCESS_H
#define CONNECTCOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning ConnectCoin processes and serving requests
...
#endif // CONNECTCOIN_IPC_PROCESS_H
