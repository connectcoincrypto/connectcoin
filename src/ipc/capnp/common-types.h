...
#ifndef CONNECTCOIN_IPC_CAPNP_COMMON_TYPES_H
#define CONNECTCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between ConnectCoin processes.
...
//! Functions to serialize / deserialize common ConnectCoin types.
namespace mp {
...
#endif // CONNECTCOIN_IPC_CAPNP_COMMON_TYPES_H
