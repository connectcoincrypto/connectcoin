...
ConnectCoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring ConnectCoin Core

**When configuring ConnectCoin Core, CMake by default will ignore the depends output.** In
...
variables will be set when generating the ConnectCoin Core build system. In this case, `-DENABLE_WALLET=OFF`.
