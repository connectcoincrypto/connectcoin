...
The ConnectCoin Core daemon can be configured to act as a trusted "border
router", implementing the ConnectCoin wire protocol and relay, making
...
The ZeroMQ feature in ConnectCoin Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ connectcoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/connectcoind.tx.raw \
...
using. Connectcoind appends an up-counting sequence number to each
