...
class ZMQTest (BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_connectcoind_zmq()
    ...
    def test_basic(self, unix = False):
        ...
        genhashes = self.generatetoaddress(self.nodes[0], num_blocks, ADDRESS_CCRT1_UNSPENDABLE)
    ...
    def test_reorg(self):
        ...
        disconnect_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_CCRT1_UNSPENDABLE, sync_fun=self.no_op)[0]
    ...
    def test_sequence(self):
        ...
        dc_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_CCRT1_UNSPENDABLE, sync_fun=self.no_op)[0]
        ...
        c_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_CCRT1_UNSPENDABLE)[0]
        ...
        self.generatetoaddress(self.nodes[1], 1, ADDRESS_CCRT1_UNSPENDABLE)
    ...
    def test_multiple_interfaces(self):
        ...
        # Generate 1 block in nodes[0] and receive all notifications
        self.generatetoaddress(self.nodes[0], 1, ADDRESS_CCRT1_UNSPENDABLE, sync_fun=self.no_op)
