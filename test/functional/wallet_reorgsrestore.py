...
class ReorgsRestoreTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        conflict_input = {"txid": txid_conflict_from, "vout": nA}

        # Keep the output reserved for the two transactions below. With a 15-coin
        # block subsidy, coin selection may otherwise spend this exact 10-coin
        # output in the next sendtoaddress call and make the test nondeterministic.
        assert self.nodes[0].lockunspent(False, [conflict_input])
        ...
        assert self.nodes[0].lockunspent(True, [conflict_input])
        inputs = [conflict_input]
        outputs_1 = {}
        outputs_2 = {}
