...
"""Verify that starting ConnectCoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ConnectCoin with -h for help text")
        ...
        self.log.info("Start ConnectCoin with -version for version information")
        ...
        self.log.info("Start connectcoind with -fakearg to make sure it does not start")
