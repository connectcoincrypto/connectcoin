...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure connectcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure connectcoind isn't accepting b28
        ...
        self.move_tip(57)
        self.next_block(59)
        tx = self.create_and_sign_transaction(out[17], 101 * COIN)
        ...
        # connectcoind doesn't disconnect us for sending a bloated block, but if we subsequently
