...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The connectcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # connectcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that connectcoind sends its own version prior to processing
