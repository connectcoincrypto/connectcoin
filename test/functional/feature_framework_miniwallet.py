...
class FeatureFrameworkMiniWalletTest(BitcoinTestFramework):
    ...
    def test_wallet_tagging(self):
        ...
        for i in range(10):
            ...
            # Leave enough value for the tagged wallet to pay ConnectCoin's
            # subsidy-penalty-aware default mining fee on its return spend.
            untagged_wallet.send_to(from_node=node, scriptPubKey=tagged_wallet.get_output_script(), amount=1_000_000)
