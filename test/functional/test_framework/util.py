...
SATOSHI_PRECISION = Decimal('0.0000000001')
...
def assert_fee_amount(fee, tx_size, feerate_cc_kvb):
...
def check_json_precision():
    ...
    connects = int(json.loads(json.dumps(float(n))) * 1.0e10)
    if connects != 2000000000000003:
...
def satoshi_round(amount: Union[int, float, str], *, rounding: str) -> Decimal:
    """Round a Decimal amount to the nearest atomic connect."""
