...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_non_witness_transaction(self):
        ...
        tx.vout.append(CTxOut(14 * COIN, CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE])))
        ...
        self.utxo.append(UTXO(tx.txid_int, 0, 14 * COIN))
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older connectcoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let connectcoind fill it in.
