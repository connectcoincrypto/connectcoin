...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('ccrt1pfees4dg9cq', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        assert_equal(res["segwit"]["desc"], "addr(ccrt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xssw47f8)#pxkajyrt")
