...
Verify that a connectcoind node can use an external signer command
...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "ccrt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th6jye4cd")
        ...
        assert_equal(address3, "TVnaMjTKy4nQ45qs4EUohZLkZs3vGva9ro")
        ...
        assert_equal(address4, "ccrt1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62msf3c54f")
        ...
        assert_equal(address_fail, "ccrt1ql7zg7ukh3dwr25ex2zn9jse926f27xy28qcm57")
        ...
        result = mock_wallet.importdescriptors([{
            "desc": "tr([00000001/86h/1h/0']tcprHuVh8FbViZHtZ3RyETUTGWN7fPRT2RcFpuzPi5v3SGhiG4u85PdTXaP8e2aoVRy41reekrWrRjKGaXdAFA4qZAYaaoEKEDumiDsfLTYRmVR/0/*)#yjea6kk8",
            "timestamp": 0,
            "range": [0,1],
            "internal": False,
            "active": True
        ...
        {
            "desc": "tr([00000001/86h/1h/0']tcprHuVh8FbViZHtZ3RyETUTGWN7fPRT2RcFpuzPi5v3SGhiG4u85PdTXaP8e2aoVRy41reekrWrRjKGaXdAFA4qZAYaaoEKEDumiDsfLTYRmVR/1/*)#4xuu8rxl",
            "timestamp": 0,
            "range": [0, 0],
            "internal": True,
            "active": True
