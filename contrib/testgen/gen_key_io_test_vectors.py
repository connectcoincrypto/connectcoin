...
bech32_templates = [
  ...
  ('tcc',  0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tcc',  0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tcc',  1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tcc',  3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tcc',  0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tcc',  0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tcc',  1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tcc',  3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
