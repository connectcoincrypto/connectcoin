...
def main():
    ...
    g.write('#ifndef CONNECTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define CONNECTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the ConnectCoin network\n')
    ...
    g.write('#endif // CONNECTCOIN_CHAINPARAMSSEEDS_H\n')
