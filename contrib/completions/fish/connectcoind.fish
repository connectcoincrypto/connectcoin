...
complete --command connectcoind --no-files

# Extract options
function __fish_connectcoind_get_options
...
complete \
    --command connectcoind \
    --arguments "(__fish_connectcoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command connectcoind \
...
complete \
    --command connectcoind \
    --arguments "(__fish_connectcoind_get_options --nofiles)"
