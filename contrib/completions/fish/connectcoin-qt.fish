...
complete --command connectcoin-qt --no-files

# Extract options
function __fish_connectcoinqt_get_options
...
complete \
    --command connectcoin-qt \
    --arguments "(__fish_connectcoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c connectcoin-qt \
...
complete \
    --command connectcoin-qt \
    --arguments "(__fish_connectcoinqt_get_options --nofiles)"
