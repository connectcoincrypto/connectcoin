...
# Extract options
function __fish_connectcoin_tx_get_options
...
# Extract commands
function __fish_connectcoin_tx_get_commands
...
# Add options
complete \
    --command connectcoin-tx \
    --condition "not __fish_connectcoin_seen_cmd (__fish_connectcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_connectcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command connectcoin-tx \
    --arguments "(__fish_connectcoin_tx_get_commands)" \
    --no-files
