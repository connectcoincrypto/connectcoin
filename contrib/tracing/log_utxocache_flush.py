...
"""Example logging ConnectCoin Core UTXO set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of connectcoind>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[connectcoind_with_usdts])
